...
const UpdateItems = ({ renderBefore, date, heading, content, dp, author }) => {
    return (
        <article className="pl-8 sm:pl-24 relative">
            ...
            <section className="h-full w-full px-4 py-5 bg-slate-800 bg-opacity-60 backdrop-blur-sm rounded-lg relative">
                {renderBefore && (
                    <div className="absolute content-[''] h-[106%] w-0 top-8 -left-5 -translate-x-0.5 border border-slate-800 z-20" />
                )}
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <h2 className="font-sans font-semibold text-gray-300 mb-2 whitespace-nowrap">{heading}</h2>
                </div>
                ...
                <footer className="items-center flex">
                    <img className="rounded-full shrink-0" src={dp} width="32" height="32"
                        alt="Author 03" />
                    <p className="text-gray-300 font-medium text-sm leading-[1.5715] pl-3">{author}</p>
                </footer>
            </section>
        </article>
    )
...
const Updates = () => {
    return (
        <main className="relative mx-auto max-w-6xl px-4 sm:px-6 pb-20 border-b border-slate-800">
            ...
            <section className="mx-auto max-w-screen-md pb-12 pt-20 text-center">
                <h1 className="text-5xl leading-[1.2] tracking-[-0.017em] font-bold md:text-6xl md:leading-none md:tracking-[-0.017em] mb-4 font-hk text-gray-300">News &amp; Updates</h1>
            ...
            <section className="md:pt-12 max-w-screen-lg mx-auto justify-between flex flex-col md:flex-row">
                ...
                <aside className="w-full md:w-[276px] shrink-0 mb-12 mr-8 md:p-4">
                    ...
                    <ul>
                        <li>
                            <a className="bg-slate-700 bg-opacity-50 transition-colors ease-in-out duration text-gray-300 items-center font-medium rounded-lg text-sm leading-[1.5715] flex mt-0.5 px-4 h-9 gap-4"
                                href="#0">
                        ...
                        <li>
                            <a className="hover:bg-slate-800 hover:bg-opacity-50 transition-colors ease-in-out duration text-gray-300 items-center font-medium rounded-lg cp2oc text-sm leading-[1.5715] flex mt-0.5 px-4 h-9 gap-4"
                                href="#0">
                                <svg className="fill-indigo-500 shrink-0" width="16" height="16"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
